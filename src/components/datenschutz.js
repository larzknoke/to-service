...
function Datenschutz({ datenschutzOpen, handleDatenschutz }) {
  ...
  return (
    <motion.div
      ...
      } impressum absolute top-auto left-0 right-0 bottom-16 md:bottom-0 m-4 p-6 md:p-8 bg-neutral-800 md:w-1/2 md:h-1/2 rounded-md overflow-scroll max-h-[75vh]`}
    >
      ...
      <div className="datenschutz-content">
        ...
        <p>
          Telefon: 0172 / 56 14 321
          <br />
          E-Mail: toservice88@gmail.com
        </p>
        <p>
